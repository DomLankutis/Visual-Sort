...
sf::VertexArray visualSort(float windowSize, int swap)
{
		int ySwap;
		for (int i = 0; i < 2; i++)
		{
...
int main()
	{
		...
		buffer.loadFromFile("C:/Users/Student/Documents/Visual Sort/Visual Sort/Visual Sort/New folder/boop.wav");
